...
public class Qualification implements Parcelable {
    public static final Parcelable.Creator<Qualification> CREATOR =
        new Parcelable.Creator<Qualification>() {
            @Override public Qualification createFromParcel(Parcel source) {
                return new Qualification(source);
            }

            @Override public Qualification[] newArray(int size) {
